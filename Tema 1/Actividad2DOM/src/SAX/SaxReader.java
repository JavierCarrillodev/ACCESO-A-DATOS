            ...
            public void endElement(String uri, String localName, String qName) {
                ...
                if (libroActual != null) {
                    switch (qName) {
                        ...
                        case "author": libroActual.addAuthor(text); break;
                        case "category": libroActual.addCategorias(text); break;
                        case "year":   if (!text.isEmpty()) libroActual.setYear(Integer.parseInt(text)); break;
                        case "price":  if (!text.isEmpty()) libroActual.setPrice(Double.parseDouble(text)); break;
