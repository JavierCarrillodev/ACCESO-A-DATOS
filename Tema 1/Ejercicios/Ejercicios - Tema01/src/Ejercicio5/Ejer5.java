...
public class Ejer5 {
    public static void main(String[] args) {
        try{
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter("Ejercicios/src/Ejercicio5/producto.txt"));
            bw.write("1;Teclado;25.5\n");
            bw.write("2;Raton;15.0\n");
            bw.write("3;Monitor;200.0\n");
            bw.close();

            BufferedReader br = new BufferedReader(new FileReader("Ejercicios/src/Ejercicio5/producto.txt"));
            BufferedWriter bw2 = new BufferedWriter(new FileWriter("Ejercicios/src/Ejercicio5/producto_acutualizado.txt"));
